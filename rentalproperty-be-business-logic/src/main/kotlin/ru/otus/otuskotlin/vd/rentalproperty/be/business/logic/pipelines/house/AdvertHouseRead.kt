...
import ru.otus.otuskotlin.vd.rentalproperty.be.business.logic.operations.stubs.house.AdvertHouseReadStub
...
object AdvertHouseRead : IOperation<BeContext> by pipeline({
  execute(InitializePipeline)

  execute(AdvertHouseReadStub)
