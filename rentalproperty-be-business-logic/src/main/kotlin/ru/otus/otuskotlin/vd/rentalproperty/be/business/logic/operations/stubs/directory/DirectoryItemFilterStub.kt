...
object DirectoryItemFilterStub : IOperation<BeContext> by pipeline({
  startIf { stubCase != StubCase.NONE }

  operation {
    startIf { stubCase == StubCase.DIRECTORY_LIST_SUCCESS }
    execute {
      responseDirectoryItems.add(DirectoryItemModel.STUB)
